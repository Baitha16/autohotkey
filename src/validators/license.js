...
const WL_CODE = /^WL-(?:[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}|[A-Za-z0-9@._-]+)$/;
const ML_CODE = /^ML-(?:[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}|[A-Za-z0-9@._-]+)$/;
const YL_CODE = /^YL-(?:[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}|[A-Za-z0-9@._-]+)$/;
const LT_CODE = /^LT-(?:[A-Z0-9]{4}-[A-Z0-9]{4}-[A-Z0-9]{4}|[A-Za-z0-9@._-]+)$/;
